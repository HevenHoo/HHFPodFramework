...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/HevenHoo/HHFPodFramework"
  ...
  s.author             = { "HevenHoo" => "hhfztl@163.com"}
  # Or just: s.author    = ""
  # s.authors            = { "" => "" }
  ...
  s.source       = { :git => "https://github.com/HevenHoo/HHFPodFramework.git", :tag => "#{s.version}" }
  ...
  s.vendored_frameworks = 'HHFPodFramework.framework'
